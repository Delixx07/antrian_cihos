...
return [
    ...
    */
    ...
    'connections' => [
        ...
        // Koneksi READ-ONLY ke database aplikasi Appointment (CIHOS). Dipakai untuk
        ...
        // Koneksi READ-ONLY ke DB MASTER bersama (cihos_master): data general
        // dokter/klinik/jadwal/prefix ruangan yang ditulis oleh aplikasi
        // Appointment (sync MEDINFRAS). Antrian hanya membaca. JANGAN menulis.
        'master' => [
            'driver' => 'mysql',
            'host' => env('MASTER_DB_HOST', '127.0.0.1'),
            'port' => env('MASTER_DB_PORT', '3306'),
            'database' => env('MASTER_DB_DATABASE', 'cihos_master'),
        ...
        'dbuser' => [
            'driver' => 'mysql',
            'host' => env('DBUSER_HOST', '127.0.0.1'),
            'port' => env('DBUSER_PORT', '3306'),
            'database' => env('DBUSER_DATABASE', 'dbuser'),
            'username' => env('DBUSER_USERNAME', 'root'),
